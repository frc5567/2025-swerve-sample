...
public class RadialActuator implements Subsystem {
    ...
    public RadialActuator(int motorPort) {
        ...
        armMotor.configSelectedFeedbackSensor(com.ctre.phoenix.motorcontrol.FeedbackDevice.CTRE_MagEncoder_Relative);
    ...
    public void setArmPosition(double position) {
        ...
        System.out.println("Attempting to move to position (" + position + ") Currently (" + curPos + ") TargetTicks (" + targetTicks + ") Currently (" + ticks + ")");
    }
